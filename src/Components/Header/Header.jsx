...
const Header = () => {
  ...
  return (
    <>
      <div className="relative w-full bg-black/20 backdrop-blur text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          <div className="inline-flex items-center space-x-2">
            <span className="font-bold">Pinfinity</span>
          </div>
            ...
            <ul className="ml-12 inline-flex space-x-8">
              {menuItems.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.href}
                    className="inline-flex items-center text-sm font-semibold text-zinc-200 hover:text-gray-900"
                  >
                    {item.name}
                    <span>
          ...
          <div className="w-full flex justify-start mx-10">
            <form onSubmit={handleSearchQuery}>
              <input
                className="w-[375%] h-10 flex  rounded-md bg-black/90 px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                type="text"
                placeholder="Search"
                value={tempQuery}
